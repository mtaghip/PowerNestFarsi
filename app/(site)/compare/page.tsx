...
export default function ComparePage() {
  ...
  return (
    <div className="r-pad" style={css`max-width:1100px;margin:0 auto;padding:26px 24px 64px`}>
      ...
      {!loading && products.length === 0 ? (
        <div className="r-roomy" style={css`background:#fff;border:1px dashed #CBD9D6;border-radius:18px;padding:56px;text-align:center`}>
        ...
        <div className="r-compare" style={css`background:#fff;border:1px solid #E3EAE8;border-radius:18px;overflow:hidden`}>
          <div
            className="r-compare-row"
            style={{ display: "grid", gridTemplateColumns: `150px repeat(${products.length},1fr)` }}
          >
